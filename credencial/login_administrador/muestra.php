		...
		<main>
			...
			<table id="tabla" class="table">
				...
				?>
					...
					<td><a href="<?php echo "editar_registro.php?id=" . $dato["id"]; ?>" target="_blank"><button id="btn_cargar_productos" class="btn active" style="background: #333333; color:#ffffff;" >Editar</button></a></td>
