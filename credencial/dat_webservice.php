...
try{
    ...
    array('cache_wsdl'=> WSDL_CACHE_NONE, 'trace' => TRUE, 'connection_timeout'=>300));
    $param = array(
        'PCUENTA' => $matricula,
			...
			<div class="col">
				<form action="insertar_archivos.php" method="POST" id="formulario" class="formulario" enctype="multipart/form-data">
					...
					<div class="col-4 col-md-4  p-4">
						<input type="text"  class="form-control " placeholder="Matrícula" name="matricula" id="matricula" required value="<?php echo substr($datos[$i]['matricula'],-10,14); ?>"  >
					</div>
					<div class="col-4 col-md-4  p-4">
                    ...
                    <div class="col-1 col-md-1  p-4">
						<input type="text" class="form-control" placeholder="Registro Federal de Contribuyentes"  name="numero" id="numero" value="<?php echo $datos[$i]['numero']; ?>"  >
					</div>
					<div class="col-4 col-md-4  p-4">
