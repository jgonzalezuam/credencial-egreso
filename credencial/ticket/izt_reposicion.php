    ...
    <div class="container">
        ...
        <div class="row  ">
            <div class="col-md-12 ">
                ...
                <div class="row  ">
                    <div class="col-md-12 ">
                        <form class="form-amount" action="buscar_izt_repo.php" method="post" >
                        ...
                        <div class="form-group col-md-12 text-center p-2">
                         ...
                         <h5 style="font-size: 15px;">Nota: Favor de enviar por correo electrónico comprobante de pago e identificación oficial.</h5>
                               ...
                               <a href="iztapalapa.php"> <button style="background: #57A519; color:white;" class="btn btn-sucess"  type="button" >Regresar</button></a>
                               <a href="../usuarios/salir.php"> <button style="background: #57A519; color:white;" class="btn btn-sucess" type="button">Finalizar sesión</button></a>
                                </div>
                            </div>
