                    ...
                    <div class="col-md-12 ">
                        <form class="form-amount" action="buscar_ler.php" method="post" >
                            ...
                            <div class="form-group col-md-4">
                                    ...
                                    <select id="inputState" name="inputState" class="form-control"  >
                                            ...
                                            <option value="DIGITAL">EMISIÓN DE CREDENCIAL FISICA</option>
                                            <option value="FISICA">EMISIÓN DE CREDENCIAL DIGITAL</option>
                        ...
                        <div class="form-group col-md-12">
							...
							<h5 style="font-size: 12px;">Nota: Presenta este formato en el área de Caja de tu Unidad de Egreso.</h5>
                                ...
                                <button style="background: #0072CE; color:white;" class="btn" onclick="printHTML()" type="button">Solicitar Ticket</button>
