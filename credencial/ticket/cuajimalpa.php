                        ...
                        <!--<div class="col-12 col-md-6 mb-3">
							...
							<h5 style="font-size: 12px;">Nota: La Fotografía debe estar en formato PNG en un tamaño de 480px X 640px</h5>
                              ...
                              <!--  <div class="form-group col-md-6 align-items-center ">
                                ...
                                <!--<button style="background: #F08200; color:white;" class="btn btn-warning " onclick="printHTML()" type="button">Solicitar Ticker</button>-->
                              <!--  <a href="cua_reposicion.php"> <button style="background: #F08200; color:white;" class="btn btn-warning" type="button">Reposición de credencial</button></a>-->

                                  <button style="background: #F08200; color:white;" class="btn btn-warning" type="button" id="btn-abrir-popup" class="btn-abrir-popup">Transferencia bancaria</button>
