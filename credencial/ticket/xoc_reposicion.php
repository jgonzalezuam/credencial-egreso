    ...
    <div class="container">
        ...
        <div class="row  ">
            <div class="col-md-12 ">
                ...
                <div class="row  ">
                    <div class="col-md-12 ">
                        <form class="form-amount" action="buscar_xoc_repo.php" method="post" >
                        ...
                        <div class="form-group col-md-12 text-center p-2">
                         ...
                         <h5 style="font-size: 15px;">Nota: Favor de enviar por correo electrónico comprobante de pago e identificación oficial.</h5>
                               ...
                               <a href="../usuarios/salir.php"> <button style="background: #0072CE; color:white" class="btn " type="button" >Finalizar sesión</button></a>  
                                </div>
                            </div>
			...
			<div class="popup" id="popup">
				...
				<form action="">
					<div class="contenedor-inputs">
                        <input type="text" placeholder="Citibanamex" disabled>
                        <input type="text" placeholder="002180057779188360" disabled>
						<input type="text" placeholder="5777918836" disabled>
					</div>
