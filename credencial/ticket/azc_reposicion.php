    ...
    <div class="container">
        ...
        <div class="row  ">
            <div class="col-md-12 ">
                ...
                <div class="row  ">
                    <div class="col-md-12 ">
                        <form class="form-amount" action="buscar_azc_repo.php" method="post" >
                        ...
                        <!--<div class="col-12 col-md-6 mb-3">
							...
							<h5 style="font-size: 12px;">Nota: La Fotografía debe estar en formato PNG en un tamaño de 480px X 640px</h5>
                              ...
                              <!--  <div class="form-group col-md-6 align-items-center ">
                                ...
                                <button style="background: #CD032E" class="btn btn-danger" type="submit" >Consultar datos</button>
                               ...
                               <a href="../usuarios/salir.php"> <button style="background: #CD032E;; color:white;" class="btn " type="button">Finalizar sesión</button></a>
                                </div>
                            </div>
