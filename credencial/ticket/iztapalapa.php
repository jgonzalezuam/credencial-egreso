...
<body id="page-top">
    ...
    <section class=""   >
        <div class="container-fluid  text-white" style="background: #57A519;" >
            ...
            <div class="col-lg-12 border" style="background: #57A519;">
    ...
    <div class="container">
        ...
        <div class="row  ">
            <div class="col-md-12 ">
                ...
                <div class="row  ">
                    <div class="col-md-12 ">
                        <form class="form-amount" action="buscar_izt.php" method="post" >
                    ...
                    <div class="form-group col-md-12 text-center p-2">
                            <h5 style="font-size: 15px;">Nota: Favor de enviar por correo electrónico comprobante de pago e identificación oficial.</h5>
                                ...
                                <div class="form-group col-md-12 text-center ">
  				                <button style="background: #57A519; color:white;" class="btn btn-sucess" type="submit" >Consultar datos</button>
                                <!--<button style="background: #57A519; color:white;" class="btn btn-sucess " onclick="printHTML()" type="button">Solicitar Ticker</button>-->
                                <!--<a href="izt_reposicion.php"> <button style="background: #57A519; color:white;" class="btn btn-sucess" type="button">Reposición de credencial</button></a>-->
                                 

                                  <button style="background: #57A519; color:white;" class="btn btn-sucess" type="button" id="btn-abrir-popup" class="btn-abrir-popup">Transferencia bancaria</button>
                                  
                                <a href="../login_registro/cerrar.php"> <button style="background: #57A519; color:white;" class="btn btn-sucess" type="button">Finalizar sesión</button></a>
                                </div>
                            </div>
