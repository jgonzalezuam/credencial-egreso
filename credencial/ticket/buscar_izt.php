                    ...
                    <?php //foreach($datos as $i=>$alumno){?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12 text-center mt-3">
                                ...
                                <button style="background: #57A519" class="btn btn-success" onclick="printHTML()" type="button">Solicitar Ticket</button>
                                ...
                                <a href="iztapalapa.php"> <button style="background: #57A519" class="btn btn-success" type="button" >Regresar</button></a>
                                <a href="../login_registro/cerrar.php"> <button style="background: #57A519" class="btn btn-success" type="button" >Finalizar sesión</button></a>
                                </div>
                    </div>
                </div>
