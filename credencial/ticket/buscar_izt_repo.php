                        ...
                        <!--<div class="col-12 col-md-6 mb-3">
							...
							<h5 style="font-size: 12px;">Nota: La Fotografía debe estar en formato PNG en un tamaño de 480px X 640px</h5>
                              ...
                              <!--  <div class="form-group col-md-6 align-items-center ">
                                ...
                                <button style="background: #57A519; color:white;" class="btn btn-success" onclick="printHTML()" type="button">Solicitar Ticker</button>
                               <a href="iztapalapa.php"> <button style="background: #57A519; color:white;" class="btn btn-success" type="button" >Regresar</button></a>
                               <a href="../usuarios/salir.php"> <button style="background: #57A519; color:white;" class="btn btn-success" type="button" >Finalizar sesión</button></a>
                                </div>
                            </div>
