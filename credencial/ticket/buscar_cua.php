...
<body id="page-top">
    ...
    <!-- Cabecera-->
    <section class=""   >
        <div class="container-fluid  text-white" style="background: #F08200;" >

            <div class="col-lg-12 border" style="background: #F08200;">
    ...
    <div class="container">
        ...
        <div class="row  ">
            <div class="col-md-12 ">
                ...
                <div class="row  ">
                    <div class="col-md-12 ">
                        <form class="form-amount" action="buscar_cua.php" method="post" >
                            ...
                            <input type="text" class="form-control" onkeyup="mayus(this);" id="plan" name="plan" placeholder="Programa de Egreso"  value="<?php echo $datos['unidad']; ?>" disabled>
                            </div> 

                            <div class="form-group col-md-4">
                           
                            <label>Año de titulación </label>
                            <input type="text" class="form-control" id="egreso" name="egreso" placeholder="Año" value="<?php echo $datos['egreso']; ?>" disabled>
                            </div> 
                        ...
                        <!--<div class="col-12 col-md-6 mb-3">
							...
							<h5 style="font-size: 12px;">Nota: La Fotografía debe estar en formato PNG en un tamaño de 480px X 640px</h5>
                              ...
                              <!--  <div class="form-group col-md-6 align-items-center ">
                                ...
                                <button style="background: #F08200; color:white;" class="btn btn-warning" onclick="printHTML()" type="button">Solicitar Ticket</button>
                                ...
                                <a href="cuajimalpa.php"> <button style="background: #F08200; color:white;" class="btn btn-warning" type="button" >Regresar</button></a>
                                <a href="../login_registro/cerrar.php"> <button style="background: #F08200; color:white;" class="btn btn-warning" type="button" >Finalizar sesión</button></a>
                                </div>
                            </div>
