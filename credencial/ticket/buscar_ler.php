                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="form-group col-md-12">
							...
							<h5 style="font-size: 12px;">Nota: Presenta este formato en el área de Caja de tu Unidad de Egreso.</h5>
                                ...
                                <button style="background: #AD25A8; color:white;" class="btn btn-sucess" onclick="printHTML()" type="button">Solicitar Ticket</button>
                                ...
                                <a href="lerma.php"> <button style="background: #AD25A8; color:white;" class="btn btn-sucess" type="button" >Regresar</button></a>
