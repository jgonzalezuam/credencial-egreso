...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <a class="navbar-brand js-scroll-trigger" ><img src="../img/egresados.png" style="height:70px;" alt=""></a>
            ...
            <a href="../salir_uno.php" class="navbar-brand js-scroll-trigger" ><button class="btn btn-dark"   type="submit">Cerrar sesión</button></a></right>
        ...
        <table class="table table-sm table-striped text-center ">
            <thead class="table-dark">
                <tr>
                    ...
                    <th>Comprobante e Identificación</th>
                    <th>Proceso</th>
                    <th>Acciones</th>
                </tr>
            </thead>
