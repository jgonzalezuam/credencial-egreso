...
try {
  ...
  $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    die();
		...
		$statement = $db->prepare('SELECT * FROM unidades WHERE usuario = :usuario LIMIT 1');
	...
	if ($errores == '') {
		$statement = $db->prepare('INSERT INTO unidades (id, usuario, pass) VALUES (null, :usuario, :pass)');
