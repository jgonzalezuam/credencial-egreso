...
try {
  ...
  $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    die();
		...
		$statement = $db->prepare('SELECT * FROM administrador WHERE usuario = :usuario LIMIT 1');
	...
	if ($errores == '') {
		$statement = $db->prepare('INSERT INTO administrador (id, usuario, pass) VALUES (null, :usuario, :pass)');
...
require 'views/registrate.view_usuario.php';
?>