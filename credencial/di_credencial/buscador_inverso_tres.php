...
<body>
	<div class="container">
		<div class="row mt-3">
			<div class="col">
				<form action="credencial_inverso_tres.php" method="POST" id="formulario" class="formulario" enctype="multipart/form-data">
                <!--<form action="datos_egresados.php" method="POST" id="formulario" class="formulario" enctype="multipart/form-data">-->
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-12 mb-3">
                        <label>Selecciona la Unidad de egreso - Nivel Licenciatura :</label>
                    <select class="custom-select" style="font-size: 13px;" name="unidad_uno" id="unidad_uno" required >
                        ...
                        <option value="xochimilco">XOCHIMILCO</option>
                         ...
                         <div class="col-12 col-md-12 mb-3">
                        <label>Selecciona la Unidad de egreso - Nivel Maestría :</label>
                    <select class="custom-select" style="font-size: 13px;" name="unidad_dos" id="unidad_dos" required >
                        <option value="">Selecciona la Unidad </option>
                        <option value="azcapotzalco">AZCAPOTZALCO</option>
                        <option value="cuajimalpa">CUAJIMALPA</option>
                        <option value="iztapalapa">IZTAPALAPA</option>                        
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        <label>Selecciona la Unidad de egreso - Nivel Doctorado :</label>
                    <select class="custom-select" style="font-size: 13px;" name="unidad_tres" id="unidad_tres" required >
                        <option value="">Selecciona la Unidad </option>
                        <option value="azcapotzalco">AZCAPOTZALCO</option>
                        <option value="cuajimalpa">CUAJIMALPA</option>
                        <option value="iztapalapa">IZTAPALAPA</option>                        
