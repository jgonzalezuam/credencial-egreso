...
<head>
    ...
    <title>Administrador - Cuajimalpa</title>    
    <script> 
    function Validar(f) { 
        if (f.email.value == "") {
...
<body id="page-top">
            ...
            <div class="row">
                <div class="col-md-10 ">
                    ...
                    <!-- Inicia Temario -->                                         
                      ...
                      <form autocomplete="on" method="POST" action="sesion_cuajimalpa.php" onsubmit="return Validar(this);">
                       ...
                       <button class="btn  text-white" type="submit" name="Submit" value="Enviar" style="background:#F08200;">Acceder</button> 
                       </div>
                        </div> 
                        </form>
                    <!-- Termina Temario -->
    ...
    <!-- Footer -->
    <footer class=" fixed-bottom py-3" style="background:#F08200;">
        <div class="container">
