...
<head>
    ...
    <title>Administrador - Xochimilco</title>    
    <script> 
    function Validar(f) { 
        if (f.email.value == "") {
...
<body id="page-top">
            ...
            <div class="row">
                <div class="col-md-10 ">
                    ...
                    <!-- Inicia Temario -->                                         
                      ...
                      <form autocomplete="on" method="POST" action="sesion_xochimilco.php" onsubmit="return Validar(this);">
                       ...
                       <button class="btn text-white" type="submit" name="Submit" value="Enviar" style="background:#0072CE;">Acceder</button> 
                       </div>
                        </div> 
                        </form>
                    <!-- Termina Temario -->
    ...
    <!-- Footer -->
    <footer class=" fixed-bottom py-3" style="background:#0072CE;">
        <div class="container">
