...
<body  oncontextmenu="return false" onkeydown="return false"> 
	<div class="contenedor">
		<header>
			...
			<div>
				<a href="salir_azc.php"><button id="btn_cargar_productos" class="btn active" style="background:#CD032E; color:#ffffff;">Cerrar sesión</button></a>
