...
<body id="page-top">
        ...
        <div class="container ">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="pb-3">Aviso</h1> <br>
                    <h3 class="pb-3">Ya existe una sesión activa para este usuario.</h3> <br>
                </div>

                <div class="col-md-12 text-center">
                    <a class="btn text-white" href="salir_cua.php" style="background:#F08200;">Cerrar Sesión</a>
                </div>
    ...
    <footer class=" fixed-bottom py-3">
        <div class="container">
            ...
            <div class="small text-center text-white" style="background:#F08200;">Universidad Autónoma Metropolitana</div>
        </div>
    </footer>
