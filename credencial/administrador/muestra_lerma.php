...
if (!isset ($_SESSION['emailLer'])){ 
   header("location: admin_lerma.php"); 
  exit(); 
} 
...
<body  oncontextmenu="return false" onkeydown="return false"> 
	<div class="contenedor">
		<header>
			...
			<div>
				<a href="salir_ler.php"><button id="btn_cargar_productos" class="btn active" style="background:#AD25A8; color:#ffffff;">Cerrar sesión</button></a>
