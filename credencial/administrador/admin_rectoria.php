...
<head>
    ...
    <title>Administrador - Rectoría General</title>    
    <script> 
    function Validar(f) { 
        if (f.email.value == "") {
            ...
            <div class="row">
                <div class="col-md-10 ">
                    ...
                    <!-- Inicia Temario -->                                         
                      ...
                      <form autocomplete="on" method="POST" action="sesion_rectoria.php" onsubmit="return Validar(this);">
                       ...
                       <input type="password" class="form-control" id="password" name="password" placeholder="Escribir contraseña"> 
                		...
                		<select class="form-control "  type="text" name="unidad" id="unidad" required>
                            ...
                            <option value="Rectoria">Rectoria General</option>
                        </select>
					</div>
