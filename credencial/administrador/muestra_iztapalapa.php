...
<body  oncontextmenu="return false" onkeydown="return false"> 
	<div class="contenedor">
		<header>
			...
			<div>
				<a href="salir_izt.php"><button id="btn_cargar_productos" class="btn active" style="background: #57A519; color:#ffffff;">Cerrar sesión</button></a>
