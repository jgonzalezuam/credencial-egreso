...
<body  oncontextmenu="return false" onkeydown="return false"> 
	<div class="contenedor">
		<header>
			...
			<div>
				<a href="salir.php"><button id="btn_cargar_productos" class="btn active" style="background: #333333; color:#ffffff;">Cerrar sesión</button></a>
 ...
 $consulta=mysql_query("SELECT * FROM credencial_egresado WHERE id=".$id.";");
 $dato=mysql_fetch_array($consulta);

?>

              <input type="text" name="name" id="name" value="<? print  $dato['rfc']; ?> " placeholder="Nombre(s)" / required>
                    <tr>
                    ...
                    <td><a href="editar_registro.php?rfc=<?php echo $dato["rfc"]; ?>" >Actualizar</a></td>
                    <td><a href="eliminar_registro.php?rfc=<?php echo $dato["rfc"]; ?> ">Eliminar</a></td>
