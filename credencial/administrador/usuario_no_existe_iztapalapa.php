...
<body id="page-top">
    ...
    <!-- Cabecera-->
    <section class="">
        <div class="container-fluid bg-dark text-white" style="background:#57A519;">
        ...
        <div class="container ">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="pb-3">Este usuario no existe, vuelve a internarlo.</h2>
                </div>

                <div class="col-md-12 text-center p-3">
                    <a class="btn text-white" href="admin_iztapalapa.php" style="background:#57A519;">Aceptar</a>
                </div>
    ...
    <footer class=" fixed-bottom py-3">
        <div class="container">
            ...
            <div class="small text-center text-white" style="background:#57A519;">Universidad Autónoma Metropolitana</div>
        </div>
    </footer>
