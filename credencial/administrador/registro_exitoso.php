...
<head>
    ...
    <link rel="icon" type="imagen/x-icon" href="img/logo.png">
        ...
        <div class="container ">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="pb-3">Tu registro fue exitoso.</h2>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center p-3">
                    <a class="btn btn-dark text-white" href="admin_unidades.php">Aceptar</a>
                </div>
            </div>
