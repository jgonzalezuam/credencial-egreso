...
<body id="page-top">
        ...
        <div class="container ">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center p-3">
                    <a class="btntext-white" href="admin_azcapotzalco.php" style="background:#CD032E;">Aceptar</a>
                </div>
    ...
    <footer class=" fixed-bottom py-3">
        <div class="container">
            ...
            <div class="small text-center text-white" style="background:#CD032E;">Universidad Autónoma Metropolitana</div>
        </div>
    </footer>
