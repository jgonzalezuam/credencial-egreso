...
<body id="page-top">
        ...
        <div class="container ">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center p-3">
                    <a class="btn text-white" href="admin_cuajimalpa.php" style="background:#F08200;">Aceptar</a>
                </div>
    ...
    <footer class=" fixed-bottom py-3">
        <div class="container">
            ...
            <div class="small text-center text-white" style="bakcground:#F08200;">Universidad Autónoma Metropolitana</div>
        </div>
    </footer>
