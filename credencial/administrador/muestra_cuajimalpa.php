...
<body  oncontextmenu="return false" onkeydown="return false"> 
	<div class="contenedor">
		<header>
			...
			<div>
				<a href="salir_cua.php"><button id="btn_cargar_productos" class="btn active" style="background: #F08200; color:#ffffff;">Cerrar sesión</button></a>
