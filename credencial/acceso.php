...
<body>
	<div class="container">
		<div class="row mt-3">
			<div class="col">
				<form action="datos_acceso.php" method="POST" id="formulario" class="formulario" enctype="multipart/form-data">
                <!--<form action="datos_egresados.php" method="POST" id="formulario" class="formulario" enctype="multipart/form-data">-->
                    <div class="form-group row">
						...
						<div class="col-12 col-md-12 mb-3">
								...
								<h5 style="font-size: 12px;">Nota: Si no recuerdas tu matrícula solicitala en <strong ><a style="text-decoration:none; color:#000;" href="mailto:egresados@correo.uam.mx" target="_blank">egresados@correo.uam.mx</a></strong> </h5>
						</div>
						...
						<div class="col-12 text-center">
							<div class="row justify-content-center">
								<div class="col-12 col-sm-12 col-md-4">
									<button class="btn btn-dark  form-inline" type="submit" name="cargar_datos" >Enviar</button>
