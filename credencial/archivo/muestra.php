...
<head>
    ...
    <title>Archivos capturados</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <a class="navbar-brand js-scroll-trigger" ><img src="../img/variacion6.png" alt=""></a>
            <a class="navbar-brand js-scroll-trigger" ><img src="../img/egresados.png" alt="" style="height:60px;"></a>
            <!--<right><a href="../excel.php" class="navbar-brand js-scroll-trigger" ><button class="btn btn-dark"   type="submit">Generar excel</button></a>-->
            <a href="salir.php" class="navbar-brand js-scroll-trigger" ><button class="btn btn-dark"   type="submit">Cerrar sesión</button></a></right>
