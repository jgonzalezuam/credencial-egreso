...
<html lang="en">
<head>
  <title>Obtener código de barras</title>
  <meta charset="utf-8">
  ...
  <div class="col-md-12">
    <div class="row">
      <div class="card col-md-4 offset-md-4 mt-5">
        ...
        <h4>Generar código de barras </h4>
    ...
    <div class="row">
      <div class="card col-md-6 mt-5 mr-5">
        <div class="card-body">
          ...
          <button type="button" class="col-md-2 btn-block float-right btn btn-dark btn-sm" id="generate">Generar</button>
        </div>
      </div>
      <div class=" card col-md-5 ml-5 mt-5" id='bcode-card'>
            ...
            <div class="card-footer" style="display:none">
              ...
              <button type="button" class=" btn-block btn btn-dark btn-sm" id="save">Descargar</button>  
              </center>
